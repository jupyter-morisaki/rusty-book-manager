...
use crate::database::model::checkout::CheckoutRow;
use crate::database::model::checkout::CheckoutStateRow;
use crate::database::model::checkout::ReturnedCheckoutRow;
            ...
            match res {
                ...
                Some(CheckoutStateRow {
                    ...
                    return Err(AppError::UnprocessableEntity(format!(
                        "A checkout for the book ({}) already exists",
                        event.book_id
                    )));
                }
                _ => {}
        ...
        self.set_transaction_serializable(&mut tx).await?;
        {
            ...
            match res {
                ...
                Some(CheckoutStateRow {
                    ...
                    return Err(AppError::UnprocessableEntity(format!(
                        "The specific checkout (ID {}, user {}, book {}) cannot be returned",
